...
class Date {
  private val months_to_days = Map(1 -> 31, 2 -> 28, 3 -> 31, 4 -> 30, 5 -> 31, 6 -> 30, 7 -> 31, 8 -> 31, 9 -> 30, 10 -> 31, 11 -> 30, 12 -> 31)
  private val months_to_numb = Map("January" -> 1, "February" -> 2, "March" -> 3, "April" -> 4,"May" -> 5,"June" -> 6,"July" -> 7,"August" -> 8,"September" -> 9,"October" -> 10,"November" -> 11,"December" -> 12)
